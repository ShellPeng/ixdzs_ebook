    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Text('${percentage.toStringAsFixed(1)}%', style: TextStyle(color: AppColor.lightGray, fontSize: 12)),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          Image.asset(icon),
          SizedBox(height: 5),
          Text(title, style: TextStyle(fontSize: fixedFontSize(12), color: AppColor.darkGray)),
        ],
      ),
    );
  }
